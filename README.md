# Case3QWERTY.TOWN
# За этот проект мы с командой на хакатоне "Моя профессия - ИТ" заняли 2-ое место.
# В команде я отвечал за бекенд составляющую (API,CRUD, интеграция с Yandex Geocoder, интеграция с LLM) , сервер, инфрастркутуру и настройку домена и SSL. 
